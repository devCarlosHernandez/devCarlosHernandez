...
<!-- HEADER ANIMADO -->
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:0d9488,50:0ea5e9,100:6366f1&height=200&section=header&text=Carlos%20Hernández%20Cruz&fontSize=40&fontColor=ffffff&fontAlignY=38&desc=Full%20Stack%20Developer%20·%20Backend%20Engineer%20·%20Systems%20Builder&descSize=16&descAlignY=58&descColor=cbd5e1&animation=fadeIn" width="100%"/>

<!-- TYPING EFFECT -->
[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=20&duration=3400&pause=800&color=0EA5E9&center=true&vCenter=true&multiline=true&repeat=true&width=750&height=80&lines=Construyendo+sistemas+que+manejan+transacciones+reales+🚀;APIs+de+alta+disponibilidad+·+Arquitecturas+Event-Driven+⚙️;Node.js+·+NestJS+·+FastAPI+·+React+·+React+Native+📱;AWS+Cloud+·+Amazon+SQS+·+Docker+·+PostgreSQL+☁️)](https://git.io/typing-svg)

<br/>

<!-- BADGES PRINCIPALES Y PORTAFOLIO -->
[![Website](https://img.shields.io/badge/🌐_Portafolio_Web-profile--personal--not3.vercel.app-0d9488?style=for-the-badge&labelColor=0f172a)](https://profile-personal-not3.vercel.app/)
...
Me especializo en diseñar soluciones resilientes de extremo a extremo, combinando backends robustos en **Node.js, NestJS y FastAPI** con interfaces reactivas y seguras en **React y React Native**, todo respaldado por la nube de **AWS, Docker y bases de datos relacionales optimizadas**.
...
### ☁️ Cloud, Infraestructura & Seguridad
...
![Neon](https://img.shields.io/badge/Neon_Serverless_PG-00E599?style=for-the-badge&logo=postgresql&logoColor=black)
...
<table>
  ...
  <tr>
    <td colspan="2" valign="top">
      ...
      <p>Pipeline distribuido para ingesta masiva, normalización y detección de anomalías en logs de servicios distribuidos en tiempo real.</p>
      <pre><code>
  [ Productores ]            [ Queue / Buffer ]       [ Worker / Consumer ]       [ Analytics / DB ]
  Node.js / Laravel APIs  →  Amazon SQS / RabbitMQ →  FastAPI & Python Workers →  PostgreSQL / S3 / Alerts
      </code></pre>
      <p>
        <img src="https://img.shields.io/badge/Node.js-339933?style=flat-square&logo=nodedotjs&logoColor=white"/>
        <img src="https://img.shields.io/badge/FastAPI-009688?style=flat-square&logo=fastapi&logoColor=white"/>
      ...
      <img src="https://img.shields.io/badge/🟡_Status-En_Mejora_Continua-eab308?style=flat-square&labelColor=0f172a"/>
    </td>
  </tr>
</table>
...
[![Portafolio Web](https://img.shields.io/badge/Portafolio_Web-profile--personal--not3.vercel.app-0d9488?style=for-the-badge&logo=vercel&logoColor=white&labelColor=0f172a)](https://profile-personal-not3.vercel.app/)
...
**Abierto a colaborar en:** `Sistemas Financieros & Pagos` · `Backend Crítico & Escalable` · `Arquitecturas Event-Driven` · `Aplicaciones PWA / Mobile` · `Full Stack con React / React Native`
